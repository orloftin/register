...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6"> 
                <p align="right"><strong> แก้ไขข้อมูลที่ได้ลงทะเบียนไปแล้ว กรุณาใส่ อีเมลล์ เพื่อแก้ไขข้อมูล </strong></p>
            </div>
                ...
                <form action="/" method="get" >
                    ...
                    <div class="col-md-10">
                        <div class="form-group">
                            <div align="left">
                                <input type="text" value="<?php echo $this->input->get('search') ?>" name="search" class="form-control col-md-12" placeholder="ใส่อีเมลล์เพื่อแก้ไขข้อมูล">
                            </div>
                        </div>
                    </div>
            ...
            $(document).ready(function() {
                ...
                <?php if ( ! empty( $list ) ): ?>
                    ...
                    <?php foreach ($option as $key => $value): ?>
                        ...
                        $('input[value="<?php echo $value ?>"]').attr('checked', true);
