            ...
            <div class="col-md-6"> 
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <div align="left">
                            <input type="text" name="search" class="form-control col-md-12" placeholder="ใส่อีเมลล์เพื่อแก้ไขข้อมูล">
                        </div>
                    </div>
                </div>
                
                <div class="col-md-2">
                    <button name="submit" class="btn btn-primary col-md-6" value="">ส่ง</button>
                </div>
